...
class Configuration(BaseModel):
    ...
    # PATCH(deep-research): endpoint override carried per request rather than via
    # os.environ, so concurrent requests on different providers cannot race.
    ...
    model_base_url: Optional[str] = Field(
        ...
        metadata={
            "x_oap_ui_config": {
                "type": "string",
                "default": "",
                "description": "Override base URL for the model endpoint (OpenRouter, Moonshot, self-hosted)"
            }
        }
    )
