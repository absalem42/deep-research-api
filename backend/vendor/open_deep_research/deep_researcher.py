...
configurable_model = init_chat_model(
    # PATCH(deep-research): "base_url" added so the endpoint can be set per
    # request instead of through a process-global environment variable.
...
async def clarify_with_user(state: AgentState, config: RunnableConfig) -> Command[Literal["write_research_brief", "__end__"]]:
    ...
    model_config = {
        ...
        # PATCH(deep-research): per-request endpoint. Upstream relied on a global
        # os.environ["ANTHROPIC_BASE_URL"] write, which raced across concurrent
        # requests using different providers.
